...
var _tabsFaq = require("./modules/tabs-faq.js");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    (0, _initSwipers.getSlider)();
    var form = new _form.Form();
    window.form = form;
    form.init();
    (0, _video.initVideos)();
    (0, _initTabs.initTabs)();
    (0, _tabsFaq.detailsDetails)();
  });
});
...
},{"./modules/form-validate/form":3,"./modules/init-swipers":9,"./modules/init-tabs":10,"./modules/tabs-faq.js":11,"./modules/tabs.js":12,"./modules/video":13,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
},{"./tabs":12}],11:[function(require,module,exports){
"use strict";
