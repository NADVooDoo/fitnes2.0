...
var _initSwiperCoaches = require("./modules/init-swiper-coaches");
var _initSwiperComments = require("./modules/init-swiper-comments");
var _tabsFaq = require("./modules/tabs-faq");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    (0, _initSwiperCoaches.getSliderCoaches)();
    (0, _initSwiperComments.getSliderComments)();
    var form = new _form.Form();
    window.form = form;
    form.init();
    (0, _video.initVideos)();
    (0, _initTabs.initTabs)();
    (0, _tabsFaq.initTabsFaq)();
  });
});
...
},{"./modules/form-validate/form":3,"./modules/init-swiper-coaches":9,"./modules/init-swiper-comments":10,"./modules/init-tabs":11,"./modules/tabs-faq":12,"./modules/video":14,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
firstNameInput.addEventListener('input', function () {
  ...
  var clearedValue = value.replace(/[^a-zA-Zа-яА-ЯЁё\s-]/g, '');
...
exports.getSliderCoaches = void 0;
var getSliderCoaches = function getSliderCoaches() {
...
exports.getSliderCoaches = getSliderCoaches;
...
exports.getSliderComments = void 0;
var getSliderComments = function getSliderComments() {
...
exports.getSliderComments = getSliderComments;
...
},{"./tabs":13}],12:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initTabsFaq = void 0;
var initTabsFaq = function initTabsFaq() {
  var detailsDetails = document.querySelectorAll('[data-answers-details]');
  var answers = document.querySelectorAll('[data-answers]');
...
exports.initTabsFaq = initTabsFaq;
...
},{"../utils/load-script.js":17}],15:[function(require,module,exports){
"use strict";
